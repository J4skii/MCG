      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/3] rounded-2xl overflow-hidden bg-slate-900 relative shadow-2xl">
               <img 
            ...
            {/* Floating Card */}
            <div className="absolute -bottom-8 -right-8 bg-slate-900 p-6 rounded-xl shadow-xl max-w-xs hidden md:block border border-slate-800">
               <p className="text-3xl font-bold text-blue-300 mb-2">20+</p>
               <p className="text-slate-400 text-sm font-medium">Active mandates nationwide across Mining, Logistics, Agriculture & Services.</p>
            </div>
          </div>

          {/* Content Side */}
          <div>
            <h2 className="text-blue-300 font-semibold uppercase tracking-wide text-sm mb-3">Who We Are</h2>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={idx} className="flex items-start gap-3">
                  <CheckCircle2 className="text-yellow-300 flex-shrink-0 mt-1" size={20} />
