    ...
    <section className="py-20 bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-blue-300 font-semibold uppercase tracking-wide text-sm mb-3">How We Work</h2>
        ...
        <div className="mb-20">
          <div className="flex items-center gap-4 mb-8">
            <div className="bg-blue-500 w-1.5 h-8 rounded-full"></div>
            <h4 className="text-2xl font-bold text-slate-100">For Entrepreneurs</h4>
          </div>
        ...
        <div>
          <div className="flex items-center gap-4 mb-8">
            <div className="bg-yellow-500 w-1.5 h-8 rounded-full"></div>
            <h4 className="text-2xl font-bold text-slate-100">For Funders & Capital Partners</h4>
          </div>
          <div className="flex flex-col lg:flex-row gap-4 overflow-x-auto pb-8 snap-x">
